...
function cssShadow({
  ...
  $('#resalt-HEX').val('background-color: ' +color+';\nopacity: '+opacity+'\nfont-size: ' +font_size+ 'px;');
  $('#resalt-RGB').val('text-shadow: ' +offset_x+'px '+offset_y+'px '+blur+'px ' +rgba+';\nfont-size: '+font_size+'px;');
...
$(document).on('input change','input',function(){
  ...
  var offset_x = $('#offset-x').val();
  var offset_y = $('#offset-y').val();
  var blur = $('#blur').val();
